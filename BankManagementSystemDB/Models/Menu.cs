    ...
    public class Menu
    {
        ...
        public static void HandleLoanMenu(string option)
        {
            ...
            try
            {
                ...
                if (!isError)
                {
                    loanService.GetLoan(AccountHolderService.loggedInAccountHolder.Id, loanAmount, loanType);
                }
            }
            catch (Exception e)
            {
        ...
        public static void HandleLoggedInAccountHolderMenu(string option)
        {
            ...
            switch (option)
            {
                ...
                case "4":
                    ...
                    Console.WriteLine(accountService.CheckBalance());
                    ShowContinueMenu();
                    HandleAccountHolderMenu("2");
                    break;
